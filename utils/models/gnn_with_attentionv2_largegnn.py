...
class GNNTorchModel(nn.Module):
    def __init__(
        ...
        self.gat = GraphAttentionV2Layer(in_features = 2048, out_features = 2048, n_heads= self.attention_network_n_heads, dropout = self.attention_network_dropout, is_concat = self.attention_network_is_concat)    
        #logger.trace(
        #    "drop out is set to "
