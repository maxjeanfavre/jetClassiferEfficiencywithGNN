...
#)
from configs.model.gnn_node_njet_edge_mass_dijet import (
    model_config as gnn_node_njet_edge_mass_dijet_model_config,
)
...
evaluation_model_selection_config = EvaluationModelSelectionConfig(
    name="gnn_node_njet_edge_mass_dijet",
    evaluation_model_configs=[
        ...
        #),
        EvaluationModelConfig(
            model_config=gnn_node_njet_edge_mass_dijet_model_config,
            run_selection="only_latest",
            run_aggregation="median",
            is_comparison_base=False,
            display_name="GNN node nJet, edge Mass dijet",
