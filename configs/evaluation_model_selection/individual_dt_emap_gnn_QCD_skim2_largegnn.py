...
from configs.model.gnn_lr0p0002_with_attentionv2_drop0p1_nhead8_largegnn import model_config as gnn_lr0p0002_with_attentionv2_drop0p1_nhead8_largegnn
...
evaluation_model_selection_config = EvaluationModelSelectionConfig(
    ...
    evaluation_model_configs=[
        ...
        EvaluationModelConfig(
            model_config = gnn_lr0p0002_with_attentionv2_drop0p1_nhead8_largegnn,
            run_selection="only_latest",
            run_aggregation="median",
            is_comparison_base=False,
            display_name="GNN_largegnn_lr0p0002_attv2_drop0p1_nhead8",
