...
from configs.model.gnn_single_wp_mode import (
    model_config as gnn_single_wp_mode_model_config,
)
...
evaluation_model_selection_config = EvaluationModelSelectionConfig(
    ...
    evaluation_model_configs=[
        ...
        EvaluationModelConfig(
            model_config=gnn_single_wp_mode_model_config,
            run_selection="all",
            run_aggregation="mean",
            is_comparison_base=False,
        ),
