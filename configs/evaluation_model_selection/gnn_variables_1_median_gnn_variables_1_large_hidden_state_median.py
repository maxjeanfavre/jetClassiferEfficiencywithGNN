...
from configs.model.gnn_variables_1_large_hidden_state import (
    model_config as gnn_variables_1_large_hidden_state_model_config,
)
...
evaluation_model_selection_config = EvaluationModelSelectionConfig(
    name="gnn_variables_1_median_gnn_variables_1_large_hidden_state_median",
