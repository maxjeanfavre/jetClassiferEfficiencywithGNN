...
from configs.model.gnn_lr0p0002_with_attentionv2_drop0p1_nhead8  import model_config as gnn_model_config_lr0p0002_with_attv2_drop0p1_nhead8 
...
evaluation_model_selection_config = EvaluationModelSelectionConfig(
    ...
    evaluation_model_configs=[
        ...
        EvaluationModelConfig(
            model_config=gnn_model_config_lr0p0004,
            run_selection="only_latest",
            run_aggregation="median",
            is_comparison_base=False,
            display_name="GNN_lr0p0004",
            only_bootstrap_runs=False,
        ),
        EvaluationModelConfig(
        ...
        EvaluationModelConfig(
            model_config = gnn_model_config_extraip_embedding6_lr0p0004,
            run_selection="only_latest",
            run_aggregation="median",
            is_comparison_base=False,
            display_name="GNN_extraip_emb6_lr0p0004",
            only_bootstrap_runs=False,
        ),
        EvaluationModelConfig(
            model_config = gnn_model_config_extraip_lr0p0002_with_attention_drop0p1_nhead8,
            run_selection="only_latest",
            run_aggregation="median",
            is_comparison_base=False,
            display_name="GNN_extraip_lr0p0002_att_drop0p1_nhead8",
            only_bootstrap_runs=False,
        ),
        EvaluationModelConfig(
            model_config = gnn_model_config_lr0p0002_with_attv2_drop0p1_nhead8 ,
            run_selection="only_latest",
            run_aggregation="median",
            is_comparison_base=False,
            display_name="GNN_lr0p0002_attv2_drop0p1_nhead8",
            only_bootstrap_runs=False,
        ),
        EvaluationModelConfig(
            model_config = gnn_model_config_lr0p0002_emb4_with_attv2_drop0p1_nhead8 ,
            run_selection="only_latest",
            run_aggregation="median",
            is_comparison_base=False,
            display_name="GNN_emb4_lr0p0002_attv2_drop0p1_nhead8",
            only_bootstrap_runs=False,
        ),
        EvaluationModelConfig(
            ...
            run_aggregation="median",
            is_comparison_base=False,
            display_name="GNN_extraip_lr0p0002_attv2_drop0p1_nhead8",
            only_bootstrap_runs=False,
        ),
        EvaluationModelConfig(
            model_config = gnn_model_config_lr0p0002_emb4_with_attention_drop0p1_nhead8 ,
            run_selection="only_latest",
            run_aggregation="median",
            is_comparison_base=False,
            display_name="GNN_emb4_lr0p0002_att_drop0p1_nhead8",
            only_bootstrap_runs=False,
        ),
        EvaluationModelConfig(
            model_config = gnn_extraip_emb6_lr0p0002_with_attention_drop0p1_nhead8_epoch30,
            run_selection="only_latest",
            run_aggregation="median",
            is_comparison_base=False,
            display_name="GNN_extraip_emb6_lr0p0002_att_drop0p1_nhead8",
            only_bootstrap_runs=False,
        ),
    ],
)
