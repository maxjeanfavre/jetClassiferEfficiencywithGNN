...
from utils.models.gnn_with_attentionv2_multilayer import GNN
...
model_config = ModelConfig(
    name="gnn_with_attentionv2_multilayer_embedding5_dropout0p3nhead8concatFalse",
    data_manipulators=(
