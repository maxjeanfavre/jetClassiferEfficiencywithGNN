...
from utils.models.gnn_with_attentionv2_largegnn import GNN
...
model_config = ModelConfig(
    name="gnn_lr0p0002_with_attentionv2_drop0p1_nhead8_largegnn",
    data_manipulators=(
    ...
    model_init_kwargs={
        ...
        "edge_hidden_state_sizes": [1024, 1024, 1024, 1024, 1024],
        "node_hidden_state_sizes": [2048, 2048, 2048, 2048, 2048],
        "jet_efficiency_net_hidden_layers": [2048, 512, 128, 64],
