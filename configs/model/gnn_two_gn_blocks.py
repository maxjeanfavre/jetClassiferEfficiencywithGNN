...
model_config.name = "gnn_two_gn_blocks"

model_config.model_init_kwargs["edge_hidden_state_sizes"] = [256, 256]
model_config.model_init_kwargs["node_hidden_state_sizes"] = [512, 512]
