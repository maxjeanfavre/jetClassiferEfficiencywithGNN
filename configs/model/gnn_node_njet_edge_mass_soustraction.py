...
from configs.model.gnn_edge_mass_dijet_soustraction import model_config as gnn_edge_mass_dijet_model_config
...
model_config.name = "gnn_node_njet_edge_mass_soustraction"
