...
dataset_config = DatasetConfig(
    name="TTTo2L2Nu",
    path=(
        "/pnfs/psi.ch/cms/trivcat/store/user/kadatta/jetObservables/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/RunIISummer20UL16PFNanov2pt2_jetObsSkim_WtopSelnomV7/240213_030219/0000/"
    ),
    key="Events;1",
    file_limit=None,
